...
* Keep the Azure DevOps and GitHub Actions slow-test reporters dormant on single-threaded WebAssembly runtimes instead of throwing `PlatformNotSupportedException` when starting their background scan loop in [#2196](https://github.com/microsoft/testfx/issues/2196)
