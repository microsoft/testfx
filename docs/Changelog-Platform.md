...
* Fall back to `dotnet <assembly>` when a Unix server-mode apphost exists but is not executable, instead of failing the launch with `Permission denied`, by @Evangelink in [#10641](https://github.com/microsoft/testfx/pull/10641)
