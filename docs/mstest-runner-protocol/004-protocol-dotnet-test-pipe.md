...
Once a POST starts, any transport, authentication, framing, or response failure makes the transport
terminal and cancels queued callers because the SDK and host protocol states may be ambiguous.
