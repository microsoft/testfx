...
## <a name="3.7.3" />[3.7.3] - 2025-02-12

See full log [here](https://github.com/microsoft/testfx/compare/v3.7.3...v3.8.0)

### Added

!!!DON'T MERGE!!! - TEMPORARY... These need to be classified to "Added"/"Fixed"/"Housekeeping" and also classified MSTest or MTP

* Upload test results for all OSes by @Evangelink in [#4327](https://github.com/microsoft/testfx/pull/4327)
* Add source build to official build by @nohwnd in [#4329](https://github.com/microsoft/testfx/pull/4329)
* Improve doc comment by @Youssef1313 in [#4335](https://github.com/microsoft/testfx/pull/4335)
* Fix incorrect doc comment by @Youssef1313 in [#4334](https://github.com/microsoft/testfx/pull/4334)
* Remove unnecessary overloads in ReflectHelper by @Youssef1313 in [#4336](https://github.com/microsoft/testfx/pull/4336)
* Mark analyzers as released by @Evangelink in [#4342](https://github.com/microsoft/testfx/pull/4342)
...
* Mark public API as shipped by @Evangelink in [#4341](https://github.com/microsoft/testfx/pull/4341)
* Make MSTest.TestFramework depends upon MSTest.Analyzers by @Evangelink in [#4351](https://github.com/microsoft/testfx/pull/4351)
* Make obsolete only on release by @Evangelink in [#4353](https://github.com/microsoft/testfx/pull/4353)
...
* Throw exception if ExpectedExceptionBaseAttribute is applied more than once by @Youssef1313 in [#4358](https://github.com/microsoft/testfx/pull/4358)
...
* Fix main by @Youssef1313 in [#4373](https://github.com/microsoft/testfx/pull/4373)
* Open source Retry and Hot Reload extensions by @Evangelink in [#4354](https://github.com/microsoft/testfx/pull/4354)
* Use test display name instead of UID for slowest tests by @Evangelink in [#4377](https://github.com/microsoft/testfx/pull/4377)
...
* Simplify test dependencies by @Evangelink in [#4382](https://github.com/microsoft/testfx/pull/4382)
* Cleanup retry and hot reload versions and refs by @Evangelink in [#4393](https://github.com/microsoft/testfx/pull/4393)
* Fix DiagnosticExtensions class name by @Youssef1313 in [#4390](https://github.com/microsoft/testfx/pull/4390)
...
* Fix DynamicDataTests by @Youssef1313 in [#4399](https://github.com/microsoft/testfx/pull/4399)
* Fix one more dynamic data test by @Youssef1313 in [#4400](https://github.com/microsoft/testfx/pull/4400)
...
* [forward port] Don't reference MTP in UWP (#4402) by @Evangelink in [#4404](https://github.com/microsoft/testfx/pull/4404)
* Fix MSTestV2Files msbuild items by @Evangelink in [#4405](https://github.com/microsoft/testfx/pull/4405)
* Cleanup MSTest.Sdk now that analyzers are deps of framework (#4407) by @Evangelink in [#4408](https://github.com/microsoft/testfx/pull/4408)
* Add changelog for 3.7.0 and 1.5.0 by @Evangelink in [#4409](https://github.com/microsoft/testfx/pull/4409)
* Update issue templates by @Youssef1313 in [#4417](https://github.com/microsoft/testfx/pull/4417)
* fix exception nullability in TryGetMessage by @SimonCropp in [#4421](https://github.com/microsoft/testfx/pull/4421)
...
* use EnumPolyfill.IsDefined by @SimonCropp in [#4418](https://github.com/microsoft/testfx/pull/4418)
* use polyfill in TestFramework.ForTestingMSTest by @SimonCropp in [#4412](https://github.com/microsoft/testfx/pull/4412)
* use EnumPolyfill.GetNames correctly by @SimonCropp in [#4413](https://github.com/microsoft/testfx/pull/4413)
* UnreachableException is more correct by @SimonCropp in [#4431](https://github.com/microsoft/testfx/pull/4431)
* leverage some global usings by @SimonCropp in [#4424](https://github.com/microsoft/testfx/pull/4424)
* Fix analyzer messages not localized by @Youssef1313 in [#4434](https://github.com/microsoft/testfx/pull/4434)
* remove redundant requestedName != null check by @SimonCropp in [#4433](https://github.com/microsoft/testfx/pull/4433)
* remove redundant bodies by @SimonCropp in [#4437](https://github.com/microsoft/testfx/pull/4437)
* merge some conditional expressions by @SimonCropp in [#4436](https://github.com/microsoft/testfx/pull/4436)
* Test coverage for TestContext analyzer for case sensitivity by @Youssef1313 in [#4438](https://github.com/microsoft/testfx/pull/4438)
* invoke methods as extension methods by @SimonCropp in [#4423](https://github.com/microsoft/testfx/pull/4423)
...
* Fix main build by @Youssef1313 in [#4446](https://github.com/microsoft/testfx/pull/4446)
* Fix main build by @Youssef1313 in [#4447](https://github.com/microsoft/testfx/pull/4447)
* Avoid tail recursion in IsAsyncDisposeImplementation by @SimonCropp in [#4432](https://github.com/microsoft/testfx/pull/4432)
* Avoid Immutable.Add by @SimonCropp in [#4442](https://github.com/microsoft/testfx/pull/4442)
* Fix typo in analyzer message by @Youssef1313 in [#4452](https://github.com/microsoft/testfx/pull/4452)
* Rename runSettingXml into runSettingsXml by @Evangelink in [#4451](https://github.com/microsoft/testfx/pull/4451)
* remove some redundant qualifiers by @SimonCropp in [#4435](https://github.com/microsoft/testfx/pull/4435)
* MSTEST0037 (proper assert analyzer): Don't report for user defined equality operators by @Youssef1313 in [#4456](https://github.com/microsoft/testfx/pull/4456)
* Fix MSTEST0017 false positive when both actual/expected are constants by @Youssef1313 in [#4460](https://github.com/microsoft/testfx/pull/4460)
* Better handling of CTS and timeout tokens by @Evangelink in [#4444](https://github.com/microsoft/testfx/pull/4444)
* Fix "Could not load file or assembly 'System.Runtime.CompilerServicesUnsafe'" by @Evangelink in [#4461](https://github.com/microsoft/testfx/pull/4461)
* remove redundant null check in ComputeStringHash by @SimonCropp in [#4420](https://github.com/microsoft/testfx/pull/4420)
* Hide DataTestMethodAttribute from IntelliSense by @Youssef1313 in [#4465](https://github.com/microsoft/testfx/pull/4465)
* Refactor running of data driven tests by @Evangelink in [#4466](https://github.com/microsoft/testfx/pull/4466)
* Small cleanup to Assert.AreEqual by @Youssef1313 in [#4472](https://github.com/microsoft/testfx/pull/4472)
...
* Update SB reference packages by @Youssef1313 in [#4485](https://github.com/microsoft/testfx/pull/4485)
* Fix match all filter not working when property expression is present by @Youssef1313 in [#4495](https://github.com/microsoft/testfx/pull/4495)
* Simplify unnecessary extension methods in analyzers by @Youssef1313 in [#4497](https://github.com/microsoft/testfx/pull/4497)
...
* Mark TestMethodOptions.Executor as non-nullable by @Youssef1313 in [#4518](https://github.com/microsoft/testfx/pull/4518)
* Move ExpectedException attribute resolution out of TypeCache/ReflectHelper by @Youssef1313 in [#4505](https://github.com/microsoft/testfx/pull/4505)
...
* Move ResolveTestContext from TypeCache to TestClassInfo by @Youssef1313 in [#4498](https://github.com/microsoft/testfx/pull/4498)
...
* Fix main build by @Youssef1313 in [#4528](https://github.com/microsoft/testfx/pull/4528)
...
* Small ClassInitialize refactoring by @Youssef1313 in [#4503](https://github.com/microsoft/testfx/pull/4503)
...
* Fix "Could not load file or assembly 'Microsoft.Testing.Platform'" ex… by @Evangelink in [#4540](https://github.com/microsoft/testfx/pull/4540)
...
* remove destructor pattern from TempDirectory by @SimonCropp in [#4545](https://github.com/microsoft/testfx/pull/4545)
* remove un-used list in ExceptionFlattener.cs by @SimonCropp in [#4548](https://github.com/microsoft/testfx/pull/4548)
* remove redundant string.ToString() by @SimonCropp in [#4550](https://github.com/microsoft/testfx/pull/4550)
* missing usings on MessageBusProxy instances by @SimonCropp in [#4547](https://github.com/microsoft/testfx/pull/4547)
* remove object based override of GetTypeDisplayName by @SimonCropp in [#4551](https://github.com/microsoft/testfx/pull/4551)
* Add dotnet test client to be used in dotnet/sdk by @nohwnd in [#4558](https://github.com/microsoft/testfx/pull/4558)
* Fix flaky `WhenSpecificDataSourceIsIgnoredViaIgnoreMessageProperty` by @Youssef1313 in [#4553](https://github.com/microsoft/testfx/pull/4553)
* Set MTP editorconfig as non-root explicitly by @Youssef1313 in [#4567](https://github.com/microsoft/testfx/pull/4567)
* make some methods static by @SimonCropp in [#4564](https://github.com/microsoft/testfx/pull/4564)
* Cleanup unnecessary await CompletedTask by @Youssef1313 in [#4562](https://github.com/microsoft/testfx/pull/4562)
* remove redundant conditional compilation in TypeCache by @SimonCropp in [#4569](https://github.com/microsoft/testfx/pull/4569)
* deconstruct some KeyValuePair by @SimonCropp in [#4573](https://github.com/microsoft/testfx/pull/4573)
* use dictionary Values directly when Key is not used by @SimonCropp in [#4574](https://github.com/microsoft/testfx/pull/4574)
* Update CODEOWNERS by @Youssef1313 in [#4576](https://github.com/microsoft/testfx/pull/4576)
* inline string literals by @SimonCropp in [#4578](https://github.com/microsoft/testfx/pull/4578)
...
* remove redundant string interpolation by @SimonCropp in [#4571](https://github.com/microsoft/testfx/pull/4571)
* fix some nullability warnings by @SimonCropp in [#4581](https://github.com/microsoft/testfx/pull/4581)
* Update CODEOWNERS by @Youssef1313 in [#4579](https://github.com/microsoft/testfx/pull/4579)
...
* [port] Fix "Found multiple properties of type 'Microsoft.Testing.Plat… by @Evangelink in [#4589](https://github.com/microsoft/testfx/pull/4589)
* better use of IsInstanceOfType by @SimonCropp in [#4583](https://github.com/microsoft/testfx/pull/4583)
* remove redundant StringBuilder in TestHostResult by @SimonCropp in [#4572](https://github.com/microsoft/testfx/pull/4572)
* Add backport GH Actions by @Youssef1313 in [#4592](https://github.com/microsoft/testfx/pull/4592)
* GH Actions backport by @Youssef1313 in [#4593](https://github.com/microsoft/testfx/pull/4593)
* Backport GH Action by @Youssef1313 in [#4595](https://github.com/microsoft/testfx/pull/4595)
* backport GH Action by @Youssef1313 in [#4596](https://github.com/microsoft/testfx/pull/4596)
* Remove env from backport by @Youssef1313 in [#4598](https://github.com/microsoft/testfx/pull/4598)
* Adjustments for Backport GH Action by @Youssef1313 in [#4601](https://github.com/microsoft/testfx/pull/4601)
* Attempt to handle conflicts in backport action by @Youssef1313 in [#4603](https://github.com/microsoft/testfx/pull/4603)
* Handle conflicts in backport GH Action by @Youssef1313 in [#4604](https://github.com/microsoft/testfx/pull/4604)
* Adjust backport PR branch name by @Youssef1313 in [#4606](https://github.com/microsoft/testfx/pull/4606)
* Progress with backport action by @Youssef1313 in [#4608](https://github.com/microsoft/testfx/pull/4608)
* Fix backport PR description by @Youssef1313 in [#4611](https://github.com/microsoft/testfx/pull/4611)
* Make Debug.Assert failure clear in CI by @Youssef1313 in [#4622](https://github.com/microsoft/testfx/pull/4622)
* Refactor TestMethodRunner.Execute so that it returns TestResult (from TestFramework) rather than UnitTestResult (from TestAdapter) by @Youssef1313 in [#4591](https://github.com/microsoft/testfx/pull/4591)
* Fix DynamicData.GetData regression preventing it to work without adapter by @Youssef1313 in [#4620](https://github.com/microsoft/testfx/pull/4620)
* Use FailFast instead of throwing in DebugEx.Assert under .NET Framework by @Youssef1313 in [#4625](https://github.com/microsoft/testfx/pull/4625)
* Fix potential race condition in GetResultOrRunClassInitialize by @Youssef1313 in [#4555](https://github.com/microsoft/testfx/pull/4555)
* Drop MSTest.Internal.TestFx.Documentation by @Evangelink in [#4627](https://github.com/microsoft/testfx/pull/4627)
* Changelog: add 3.7.1 and 1.5.1 by @Evangelink in [#4631](https://github.com/microsoft/testfx/pull/4631)
* Revert source build by @nohwnd in [#4637](https://github.com/microsoft/testfx/pull/4637)
* Cleanup unneeded IVT by @Youssef1313 in [#4643](https://github.com/microsoft/testfx/pull/4643)
* Avoid keeping trx stream open in unit tests by @Youssef1313 in [#4642](https://github.com/microsoft/testfx/pull/4642)
* Drop package ref to System.Memory by @Evangelink in [#4651](https://github.com/microsoft/testfx/pull/4651)
...
* Fix Tuple/ValueTuple handling of TRest by @Youssef1313 in [#4639](https://github.com/microsoft/testfx/pull/4639)
...
* Fix xlf by @Evangelink in [#4665](https://github.com/microsoft/testfx/pull/4665)
* Update README.md by @Youssef1313 in [#4667](https://github.com/microsoft/testfx/pull/4667)
* Drop unused source gen related code by @Evangelink in [#4662](https://github.com/microsoft/testfx/pull/4662)
* Ensure IProperty record implementation have nice array display by @Evangelink in [#4658](https://github.com/microsoft/testfx/pull/4658)
* Fix bad nullability annotation on CultureInfo by @Evangelink in [#4670](https://github.com/microsoft/testfx/pull/4670)
* Remove non-working <inheritdoc /> by @Evangelink in [#4668](https://github.com/microsoft/testfx/pull/4668)
* Do more async work by @Youssef1313 in [#4674](https://github.com/microsoft/testfx/pull/4674)
* Revert "[main] Bump MSTest from 3.8.0-preview.25063.12 to 3.8.0-preview.25065.17" by @Youssef1313 in [#4680](https://github.com/microsoft/testfx/pull/4680)
* Drop tests that are irrelevant by @Evangelink in [#4675](https://github.com/microsoft/testfx/pull/4675)
* Fix bad auto merge by @Evangelink in [#4684](https://github.com/microsoft/testfx/pull/4684)
* Fix tuple regression before it's shipped :) by @Youssef1313 in [#4678](https://github.com/microsoft/testfx/pull/4678)
* Add API docs feedback template by @Youssef1313 in [#4687](https://github.com/microsoft/testfx/pull/4687)
* Update z-apidocs-feedback.yml by @Youssef1313 in [#4688](https://github.com/microsoft/testfx/pull/4688)
* Avoid using UnitTestResult and use TestResult directly by @Youssef1313 in [#4686](https://github.com/microsoft/testfx/pull/4686)
...
* Delete GenericParameterHelperTests by @Youssef1313 in [#4705](https://github.com/microsoft/testfx/pull/4705)
* Re-word async void analyzer description by @Youssef1313 in [#4710](https://github.com/microsoft/testfx/pull/4710)
* Cleanup unit test outcome conversion by @Youssef1313 in [#4726](https://github.com/microsoft/testfx/pull/4726)
* Misc code cleanup by @Youssef1313 in [#4728](https://github.com/microsoft/testfx/pull/4728)
* [Refactor] Simplify FixtureTestResult by @Youssef1313 in [#4723](https://github.com/microsoft/testfx/pull/4723)
* Remove AsyncTestProperty by @Youssef1313 in [#4725](https://github.com/microsoft/testfx/pull/4725)
* Delete unused extension method `ToAdapterOutcome` by @Youssef1313 in [#4735](https://github.com/microsoft/testfx/pull/4735)
* [Refactor] Cleanup class/assembly cleanup by @Youssef1313 in [#4732](https://github.com/microsoft/testfx/pull/4732)
...
* Update changelog for 3.7.2/1.5.2 release by @Youssef1313 in [#4745](https://github.com/microsoft/testfx/pull/4745)
* Fix date in changelog by @Youssef1313 in [#4746](https://github.com/microsoft/testfx/pull/4746)
...
* [tests] print content of the runtimeconfig when it's malformed by @Evangelink in [#4750](https://github.com/microsoft/testfx/pull/4750)
* Drop explicit use of DynamicDataSourceType by @Evangelink in [#4755](https://github.com/microsoft/testfx/pull/4755)
* Improve generic support by @Youssef1313 in [#4739](https://github.com/microsoft/testfx/pull/4739)
...
* Fix wrong Trx warning by @Youssef1313 in [#4758](https://github.com/microsoft/testfx/pull/4758)
* Workaround flakiness for AnalysisMode test by @Youssef1313 in [#4764](https://github.com/microsoft/testfx/pull/4764)
* Do not capture test output on CI by @Evangelink in [#4765](https://github.com/microsoft/testfx/pull/4765)
* Speedup analysis mode acceptance test by @Evangelink in [#4757](https://github.com/microsoft/testfx/pull/4757)
* Produce binlogs from integration tests by @Youssef1313 in [#4761](https://github.com/microsoft/testfx/pull/4761)
* Cleanup test oriented Directory.Build.props by @Evangelink in [#4766](https://github.com/microsoft/testfx/pull/4766)
* remove destructor pattern from LogMessageListener by @SimonCropp in [#4585](https://github.com/microsoft/testfx/pull/4585)
...
* Remove redundant properties by @Youssef1313 in [#4782](https://github.com/microsoft/testfx/pull/4782)
* Cleanup dead code by @Youssef1313 in [#4783](https://github.com/microsoft/testfx/pull/4783)
* Avoid using ToUnitTestResults in unit tests by @Youssef1313 in [#4781](https://github.com/microsoft/testfx/pull/4781)
* Disable MSTEST0015 in various profiles by @Evangelink in [#4784](https://github.com/microsoft/testfx/pull/4784)
* Rename MacOSX to OSX and introduce FreeBSD by @Youssef1313 in [#4789](https://github.com/microsoft/testfx/pull/4789)
* Delete unused method by @Youssef1313 in [#4788](https://github.com/microsoft/testfx/pull/4788)
* Add tests for Polyfill type forwarding by @Youssef1313 in [#4796](https://github.com/microsoft/testfx/pull/4796)
* Bump version used in samples to latest by @Evangelink in [#4798](https://github.com/microsoft/testfx/pull/4798)
* Add Contains/DoesNotContain assert APIs by @Evangelink in [#4799](https://github.com/microsoft/testfx/pull/4799)
* Fix builder extension names by @Evangelink in [#4800](https://github.com/microsoft/testfx/pull/4800)
* Update Changelog for 3.7.3/1.5.3 by @Youssef1313 in [#4805](https://github.com/microsoft/testfx/pull/4805)
* Bump version used in samples to latest by @Youssef1313 in [#4807](https://github.com/microsoft/testfx/pull/4807)
* Use field keyword by @Youssef1313 in [#4809](https://github.com/microsoft/testfx/pull/4809)
* Drop `-m:1 -nodeReuse:false` from acceptance tests infra by @Evangelink in [#4804](https://github.com/microsoft/testfx/pull/4804)
...
* Retry: mark as experimental extension points by @Evangelink in [#4812](https://github.com/microsoft/testfx/pull/4812)
* Add GitHubWorkItem by @Evangelink in [#4813](https://github.com/microsoft/testfx/pull/4813)
* Cleanup props/targets copy to output by @Evangelink in [#4823](https://github.com/microsoft/testfx/pull/4823)
* Disable MSTEST0026 by default by @Evangelink in [#4816](https://github.com/microsoft/testfx/pull/4816)
* Cleanup dead code in TestRunCancellationToken by @Youssef1313 in [#4824](https://github.com/microsoft/testfx/pull/4824)
...
* fix Warning CS9113 : Parameter 'testFramework' is unread. by @SimonCropp in [#4846](https://github.com/microsoft/testfx/pull/4846)
* remove redundant PathComparer by @SimonCropp in [#4861](https://github.com/microsoft/testfx/pull/4861)
* remove redundant RenderedHeight by @SimonCropp in [#4866](https://github.com/microsoft/testfx/pull/4866)
* remove un-used ActionResult  builders by @SimonCropp in [#4854](https://github.com/microsoft/testfx/pull/4854)
* remove TestProgressState Attachments by @SimonCropp in [#4864](https://github.com/microsoft/testfx/pull/4864)
* remove INamedPipeBase by @SimonCropp in [#4860](https://github.com/microsoft/testfx/pull/4860)
* only wrap required console members by @SimonCropp in [#4869](https://github.com/microsoft/testfx/pull/4869)
* remove FormattedTextOutputDeviceDataBuilder by @SimonCropp in [#4870](https://github.com/microsoft/testfx/pull/4870)
* remove redundant PropertyPerEdgeChars by @SimonCropp in [#4852](https://github.com/microsoft/testfx/pull/4852)
* remove redundant HostProperties by @SimonCropp in [#4849](https://github.com/microsoft/testfx/pull/4849)
* remove WellKnownTypeNames by @SimonCropp in [#4856](https://github.com/microsoft/testfx/pull/4856)
* remove IsAsyncDisposeImplementation by @SimonCropp in [#4875](https://github.com/microsoft/testfx/pull/4875)
* remove IsHotReloadSupported by @SimonCropp in [#4868](https://github.com/microsoft/testfx/pull/4868)
* remove redundant TestContext  in sample by @SimonCropp in [#4872](https://github.com/microsoft/testfx/pull/4872)
* remove redundant IPushOnlyProtocol.Name by @SimonCropp in [#4851](https://github.com/microsoft/testfx/pull/4851)
* remove TestNodeUpdateCollector.IsComplete by @SimonCropp in [#4878](https://github.com/microsoft/testfx/pull/4878)
* remove un-used members from PooledHashSet by @SimonCropp in [#4877](https://github.com/microsoft/testfx/pull/4877)
* remove redundant AddDataConsumer by @SimonCropp in [#4858](https://github.com/microsoft/testfx/pull/4858)
* remove ExtractVersionFromVersionPropsFile by @SimonCropp in [#4880](https://github.com/microsoft/testfx/pull/4880)
* pass some missing cancellationTokens by @SimonCropp in [#4857](https://github.com/microsoft/testfx/pull/4857)
* remove GetDisplayName by @SimonCropp in [#4882](https://github.com/microsoft/testfx/pull/4882)
* remove redundant AssemblyDiscoveryCompleted by @SimonCropp in [#4863](https://github.com/microsoft/testfx/pull/4863)
* remove IsDisposeImplementation by @SimonCropp in [#4874](https://github.com/microsoft/testfx/pull/4874)
* Cleanup VB entrypoint by @Youssef1313 in [#4884](https://github.com/microsoft/testfx/pull/4884)
* remove redundant GetCommandLineArguments by @SimonCropp in [#4850](https://github.com/microsoft/testfx/pull/4850)
* remove redundant ITask members by @SimonCropp in [#4867](https://github.com/microsoft/testfx/pull/4867)
* remove DynamicDataTargetAssetPath and TestSourceDataTargetAssetPath by @SimonCropp in [#4879](https://github.com/microsoft/testfx/pull/4879)
* Fix MSTest metapackage README by @Youssef1313 in [#4887](https://github.com/microsoft/testfx/pull/4887)
* Drop unnecessary `PackageVersion` entries by @Youssef1313 in [#4891](https://github.com/microsoft/testfx/pull/4891)
* fix Warning IDE0052 member can be removed as the value assigned to it is never read by @SimonCropp in [#4845](https://github.com/microsoft/testfx/pull/4845)
* convert _testApplicationModuleInfo to a local variable by @SimonCropp in [#4896](https://github.com/microsoft/testfx/pull/4896)
* remove TerminalOutputDevice _process by @SimonCropp in [#4895](https://github.com/microsoft/testfx/pull/4895)
* avoid 2x string allocs in TerminalOutputDevice by @SimonCropp in [#4894](https://github.com/microsoft/testfx/pull/4894)
* rename ExecutableInfo FileName to FilePath by @SimonCropp in [#4892](https://github.com/microsoft/testfx/pull/4892)
* Remove `TestRequestExecutionTimeInfo` from `TerminalOutputDevice.DataTypesConsumed` by @Youssef1313 in [#4903](https://github.com/microsoft/testfx/pull/4903)
* use range in FailedTestHelper.cs by @SimonCropp in [#4901](https://github.com/microsoft/testfx/pull/4901)
* remove redundant ServiceProviderExtensions by @SimonCropp in [#4859](https://github.com/microsoft/testfx/pull/4859)
* remove ReportNoLocationDiagnostic by @SimonCropp in [#4873](https://github.com/microsoft/testfx/pull/4873)
* Disable CentralPackageTransitivePinningEnabled by @Youssef1313 in [#4888](https://github.com/microsoft/testfx/pull/4888)
* remove TerminalOutputDevice ITestApplicationCancellationTokenSource f… by @SimonCropp in [#4893](https://github.com/microsoft/testfx/pull/4893)
* Cleanup dead code by @Evangelink in [#4906](https://github.com/microsoft/testfx/pull/4906)
* Fix DiagnosticSeverity.Info in generated globalconfig by @Youssef1313 in [#4909](https://github.com/microsoft/testfx/pull/4909)
* remove ITool.Hidden by @SimonCropp in [#4855](https://github.com/microsoft/testfx/pull/4855)
* GetExceptionMessage exception cant be null by @SimonCropp in [#4900](https://github.com/microsoft/testfx/pull/4900)
* Remove dead code related to filtering by @Youssef1313 in [#4914](https://github.com/microsoft/testfx/pull/4914)
* Move away from nuspec for MSTest metapackage by @Youssef1313 in [#4818](https://github.com/microsoft/testfx/pull/4818)
...
* fix incorrect FirstOrDefault usage by @SimonCropp in [#4580](https://github.com/microsoft/testfx/pull/4580)
* Add UWP .NET 9 support for MSTest extensions by @Sergio0694 in [#3848](https://github.com/microsoft/testfx/pull/3848)
* remove _hangDumpConfiguration by @SimonCropp in [#4935](https://github.com/microsoft/testfx/pull/4935)
* Move ServerMode directory from MSTest acceptance tests to MTP acceptance tests by @Youssef1313 in [#4932](https://github.com/microsoft/testfx/pull/4932)
* remove redundant exit code by @SimonCropp in [#4853](https://github.com/microsoft/testfx/pull/4853)
* JoinSingleLineAndShorten first cant be null by @SimonCropp in [#4897](https://github.com/microsoft/testfx/pull/4897)
* MSTEST0018: Fix FP with types implementing IEnumerable by @Evangelink in [#4924](https://github.com/microsoft/testfx/pull/4924)
* remove messageFormatOnException in CreateNavigationSession by @SimonCropp in [#4549](https://github.com/microsoft/testfx/pull/4549)
* New Assert APIs: ensure expected is first by @Evangelink in [#4939](https://github.com/microsoft/testfx/pull/4939)
...
* Preserve TestIdGenerationStrategy in the execution AppDomain - round 2 by @Youssef1313 in [#4954](https://github.com/microsoft/testfx/pull/4954)
* Set SkipArcadeNoWarnCS1591 to true by @Youssef1313 in [#4937](https://github.com/microsoft/testfx/pull/4937)
* Add TrxReport dependency to MSTest metapackage by @Youssef1313 in [#4956](https://github.com/microsoft/testfx/pull/4956)
* Refactor discovery to build specific info for discovery by @Youssef1313 in [#4958](https://github.com/microsoft/testfx/pull/4958)
* Add TestDataRow class by @Youssef1313 in [#4930](https://github.com/microsoft/testfx/pull/4930)
* Uncomment asserts in TestClassInfo by @Youssef1313 in [#4960](https://github.com/microsoft/testfx/pull/4960)
* Rely on CS1591 instead of SA1600 and SA1601 by @Evangelink in [#4963](https://github.com/microsoft/testfx/pull/4963)
* Better failure for flaky test by @Youssef1313 in [#4965](https://github.com/microsoft/testfx/pull/4965)
* Simplify inclusion of MSTestVersion.cs and PlatformVersion.cs by @Youssef1313 in [#4964](https://github.com/microsoft/testfx/pull/4964)
* Workaround UsingTestDataRowVariousCases flakiness by @Youssef1313 in [#4967](https://github.com/microsoft/testfx/pull/4967)
...
* Include RootNamespace in hash calculation for MTP MSBuild generated files by @Youssef1313 in [#4969](https://github.com/microsoft/testfx/pull/4969)
* Move `Microsoft.Win32.Registry` dependency from "Test dependencies" to "Product dependencies" by @Youssef1313 in [#4982](https://github.com/microsoft/testfx/pull/4982)
* Remove redundant explicit override of NuGet.Packaging and MessagePack by @Youssef1313 in [#4981](https://github.com/microsoft/testfx/pull/4981)
* Bump .NET runtimes by @Evangelink in [#4983](https://github.com/microsoft/testfx/pull/4983)
* Follow-up to the move of SourceGen + Engine by @Youssef1313 in [#4971](https://github.com/microsoft/testfx/pull/4971)
* [rel/3.8] Update deps by @Youssef1313 in [#4984](https://github.com/microsoft/testfx/pull/4984)
...
* Add TestException property to the TestContext by @Evangelink in [#4018](https://github.com/microsoft/testfx/pull/4018)
...
* Avoid dictionary resizes when the size is approximately known by @Youssef1313 in [#4313](https://github.com/microsoft/testfx/pull/4313)
