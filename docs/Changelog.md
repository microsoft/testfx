...
* Support "Central Package Management" with the MSTest.Sdk by @MarcoRossignoli in [#2581](https://github.com/microsoft/testfx/2581)
* MSTEST0019: Prefer TestInitialize over ctor by @Evangelink in [#2580](https://github.com/microsoft/testfx/2580)
* MSTEST0020: Prefer ctors over TestInitialize methods by @Evangelink in [#2582](https://github.com/microsoft/testfx/2582)
* MSTEST0021: Prefer Dispose over TestCleanup methods by @Evangelink in [#2585](https://github.com/microsoft/testfx/2585)
* MSTEST0022: Prefer 'TestCleanup' methods over Dispose by @Evangelink in [#2586](https://github.com/microsoft/testfx/2586)
* MSTEST0023: Do not negate boolean assertions by @Evangelink in [#2594](https://github.com/microsoft/testfx/2594)
* MSTEST0024: Do not store TestContext in static members by @Evangelink in [#2597](https://github.com/microsoft/testfx/2597)
* Use System.Text.Json instead of Jsonite y @mariam-abdulla in [#2564](https://github.com/microsoft/testfx/2564)
* Update MSTest.Sdk to handle playwright by @Evangelink in [#2598](https://github.com/microsoft/testfx/2598)
* Add support for runner in WinUI mode by @Evangelink in [#2617](https://github.com/microsoft/testfx/2617)
* Init and cleanup timeout by @engyebrahim in [#2570](https://github.com/microsoft/testfx/2570)
* Add project samples for MSTest.Sdk by @Evangelink in [#2675](https://github.com/microsoft/testfx/2675)
* Cache CommandLineOption from the providers by @MarcoRossignoli in [#2680](https://github.com/microsoft/testfx/2680)
* Simplify Microsoft.Testing.Platform banner by @Evangelink in [#2686](https://github.com/microsoft/testfx/2686)
* Add support for STA thread by @Evangelink in [#2682](https://github.com/microsoft/testfx/2682)
* Improve error message when dynamic data source layout is invalid by @Evangelink in [#2690](https://github.com/microsoft/testfx/2690)
* Add global using feature in MSTest.Sdk by @Varorbc in [#2701](https://github.com/microsoft/testfx/2701)
* Added AssertInstanceOf overloads with out parameter by @Mrxx99 in [#2717](https://github.com/microsoft/testfx/2717)
* Improve error message for mismatched data driven test by @Evangelink in [#2691](https://github.com/microsoft/testfx/2691)
* SDK: add playwright default using by @Evangelink in [#2730](https://github.com/microsoft/testfx/2730)
* SDK: add global usings to VSTest targets by @Evangelink in [#2731](https://github.com/microsoft/testfx/2731)
* MSTest.Sdk: add support for Aspire by @Evangelink in [#2758](https://github.com/microsoft/testfx/2758)
* Ensure that fixtures also support sta threading by @Evangelink in [#2769](https://github.com/microsoft/testfx/2769)
