...
public class UnitTestRunnerTests
{
    ...
    {
        testRunParameters = new Dictionary<string, object>();
        ...
        unitTestRunner = new UnitTestRunner(GetSettingsWithDebugTrace(false));
    }
    ...
    {
        void a() => unitTestRunner.RunSingleTest(null, null);
    ...
    public void RunSingleTestShouldThrowIfTestRunParamtersIsNull()
    {
        ...
        void a() => unitTestRunner.RunSingleTest(testMethod, null);
        ActionUtility.ActionShouldThrowExceptionOfType(a, typeof(ArgumentNullException));
    }
    ...
    public void RunSingleTestShouldReturnTestResultIndicateATestNotFoundIfTestMethodCannotBeFound()
    {
        ...
        testablePlatformServiceProvider.MockFileOperations.Setup(fo => fo.LoadAssembly("A", It.IsAny<bool>()))
            .Returns(Assembly.GetExecutingAssembly());

        var results = unitTestRunner.RunSingleTest(testMethod, testRunParameters);
    ...
    public void RunSingleTestShouldCallAssemblyInitializeAndClassInitializeMethodsInOrder()
    {
        ...
        unitTestRunner = new UnitTestRunner(new MSTestSettings(), mockReflectHelper.Object);
        ...
        unitTestRunner.RunSingleTest(testMethod, testRunParameters);
    ...
    {
        Assert.IsNull(unitTestRunner.RunCleanup());
    }
    ...
    public void RunCleanupShouldReturnCleanupResultsForAssemblyAndClassCleanupMethods()
    {
        ...
        var cleanupresult = unitTestRunner.RunCleanup();
