...
#pragma warning restore RS0030 // Do not use banned APIs
        ...
        actualErrorMessage!.StartsWith(
            $"Assembly Cleanup method DummyTestClass.AssemblyCleanupMethod failed. Error Message: Assertion failed.{global::System.Environment.NewLine}Test Failure..", StringComparison.Ordinal).Should().BeTrue($"Value: {actualErrorMessage}");
    }
