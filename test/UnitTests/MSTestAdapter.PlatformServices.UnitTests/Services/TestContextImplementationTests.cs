...
public class TestContextImplementationTests : TestContainer
{
    ...
    public void DisplayMessageShouldForwardToIMessageLogger()
    {
        ...
        _testContextImplementation = new TestContextImplementation(_testMethod.Object, new ThreadSafeStringWriter(null!, "test"), _properties, messageLoggerMock.Object, null);
