...
public partial class AssertTests
{
    ...
    public async Task Count_InterpolatedString_WhenCountIsNotSame_ShouldFail()
    {
        ...
        ex.Message.Should().Be($"Assert.HasCount failed. Expected collection of size 1. Actual: 0. User-provided message. DummyClassTrackingToStringCalls,     DummyClassTrackingToStringCalls, Hello, DummyIFormattable.ToString(), {string.Format(null, "{0:tt}", dateTime)}, {string.Format(null, "{0,5:tt}", dateTime)}");
        o.WasToStringCalled.Should().BeTrue();
    }
    ...
    public async Task NotAny_InterpolatedString_WhenNotEmpty_ShouldFail()
    {
        ...
        ex.Message.Should().Be($"Assert.IsEmpty failed. Expected collection of size 0. Actual: 1. User-provided message. DummyClassTrackingToStringCalls,     DummyClassTrackingToStringCalls, Hello, DummyIFormattable.ToString(), {string.Format(null, "{0:tt}", dateTime)}, {string.Format(null, "{0,5:tt}", dateTime)}");
        o.WasToStringCalled.Should().BeTrue();
    }
    ...
    public void Single_WhenNoItems_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected collection to contain exactly one element but found 0 element(s). ");
    }

    public void Single_WhenMultipleItems_ShouldFail()
    {
        Exception ex = VerifyThrows(() => Assert.ContainsSingle([1, 2, 3]));
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected collection to contain exactly one element but found 3 element(s). ");
    }
    ...
    public void Single_MessageArgs_WhenNoItem_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected collection to contain exactly one element but found 0 element(s). User-provided message: System.Object type: System.Object");
    }
    ...
    public void Single_MessageArgs_WhenMultipleItems_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected collection to contain exactly one element but found 3 element(s). User-provided message: System.Object type: System.Object");
    }
...
#pragma warning restore CA1865
    ...
    public void SinglePredicate_WhenNoItemMatches_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected exactly one item to match the predicate but found 0 item(s). ");
    }
    ...
    public void SinglePredicate_WhenMultipleItemsMatch_ShouldFail()
    {
        ...
        Exception ex = VerifyThrows(() => Assert.ContainsSingle(x => x % 2 == 0, collection));
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected exactly one item to match the predicate but found 3 item(s). ");
    }
    ...
    public void SinglePredicate_Message_WhenNoItemMatches_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected exactly one item to match the predicate but found 0 item(s). No even numbers found: test");
    }
    ...
    public void SinglePredicate_Message_WhenMultipleItemsMatch_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.ContainsSingle failed. Expected exactly one item to match the predicate but found 3 item(s). Too many even numbers: test");
    }
    ...
    public async Task Any_InterpolatedString_WhenNoItem_ShouldFail()
    {
        ...
        ex.Message.Should().Be($"Assert.IsNotEmpty failed. Expected collection to contain any item but it is empty. User-provided message. DummyClassTrackingToStringCalls,     DummyClassTrackingToStringCalls, Hello, DummyIFormattable.ToString(), {string.Format(null, "{0:tt}", dateTime)}, {string.Format(null, "{0,5:tt}", dateTime)}");
        o.WasToStringCalled.Should().BeTrue();
    }
}
