...
public partial class AssertTests : TestContainer
{
    ...
    public void AreEqual_WithEnglishCultureAndDoesNotIgnoreCase_Throws()
    {
        ...
        ex.Message.Should().Be("Assert.AreEqual failed. Expected:<i>. Case is different for actual value:<I>. ");
    }
...
#pragma warning restore IDE0004
    ...
    public void FloatAreEqual_ExpectedIsNumeric_ActualIsNumeric_ExpectedAndActualDifferenceGreaterThanDeltaPositive_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreEqual failed. Expected a difference no greater than <2> between expected value <5> and actual value <2>. ");
    }
    ...
    public void FloatAreEqual_ExpectedIsNumeric_ActualIsNumeric_ExpectedAndActualDifferenceGreaterThanDeltaNegative_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreEqual failed. Expected a difference no greater than <2> between expected value <2> and actual value <5>. ");
    }
    ...
    public void FloatAreEqual_ExpectedIsNumeric_ActualIsNaN_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreEqual failed. Expected a difference no greater than <2> between expected value <5> and actual value <NaN>. ");
    }
    ...
    public void FloatAreEqual_ExpectedIsNaN_ActualIsNumeric_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreEqual failed. Expected a difference no greater than <2> between expected value <NaN> and actual value <5>. ");
    }
    ...
    public void FloatAreNotEqual_ExpectedIsNumeric_ActualIsNumeric_ExpectedAndActualDifferenceLessThanDeltaPositive_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreNotEqual failed. Expected a difference greater than <2> between expected value <5> and actual value <4>. ");
    }
    ...
    public void FloatAreNotEqual_ExpectedIsNumeric_ActualIsNumeric_ExpectedAndActualDifferenceLessThanDeltaNegative_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreNotEqual failed. Expected a difference greater than <2> between expected value <4> and actual value <5>. ");
    }
    ...
    public void FloatAreNotEqual_ExpectedIsNaN_ActualIsNaN_DeltaIsNumeric_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.AreNotEqual failed. Expected a difference greater than <2> between expected value <NaN> and actual value <NaN>. ");
    }
