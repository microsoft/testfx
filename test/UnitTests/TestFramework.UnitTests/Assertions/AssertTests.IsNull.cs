...
public partial class AssertTests : TestContainer
{
    ...
    public void IsNull_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.IsNull failed. ");
    }
    ...
    public void IsNull_StringMessage_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.IsNull failed. User-provided message");
    }
    ...
    public async Task IsNull_InterpolatedString_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be($"Assert.IsNull failed. User-provided message. DummyClassTrackingToStringCalls,     DummyClassTrackingToStringCalls, Hello, DummyIFormattable.ToString(), {string.Format(null, "{0:tt}", dateTime)}, {string.Format(null, "{0,5:tt}", dateTime)}");
        o.WasToStringCalled.Should().BeTrue();
    }
    ...
    public void IsNull_MessageFormat_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.IsNull failed. User-provided message System.Object");
    }
    ...
    public void IsNotNull_PassNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.IsNotNull failed. ");
    }
    ...
    public void IsNotNull_StringMessage_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.IsNotNull failed. User-provided message");
    }
    ...
    public async Task IsNotNull_InterpolatedString_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be($"Assert.IsNotNull failed. User-provided message. DummyClassTrackingToStringCalls,     DummyClassTrackingToStringCalls, Hello, DummyIFormattable.ToString(), {string.Format(null, "{0:tt}", dateTime)}, {string.Format(null, "{0,5:tt}", dateTime)}");
        o.WasToStringCalled.Should().BeTrue();
    }
    ...
    public void IsNotNull_MessageFormat_PassNonNull_ShouldFail()
    {
        ...
        ex.Message.Should().Be("Assert.IsNotNull failed. User-provided message System.Object");
    }
}
