...
public partial class AssertTests : TestContainer
{
    ...
    public void Contains_ValueExpected_ItemDoesNotExist_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.Contains failed. Item 20 not found
    ...
    public void Contains_InNonGenericCollection_NullableValueExpected_ItemDoesNotExist_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.Contains failed. Item  not found
            Expected collection to contain the specified item.
              collection*
            """);
    }
    ...
    public void Contains_WithComparer_ItemDoesNotExist_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.Contains failed. Missing cherry
            Expected collection to contain the specified item.
              expected: "cherry"
              collection*
            """);
    ...
    public void Contains_Predicate_NoItemMatches_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.Contains failed. No even number found
    ...
    public void Contains_StringVersion_SubstringNotPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.Contains failed. Missing substring
    ...
    public void DoesNotContain_ValueExpected_ItemPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. Item 10 should not be found
    ...
    public void DoesNotContain_InNonGenericCollection_ValueExpected_ItemPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. Assert.DoesNotContain failed. Expected collection to not contain the specified item. Item {0} should not be found
            Expected collection to not contain the specified item.
              notExpected: 10
              collection*
            """);
    ...
    public void DoesNotContain_WithComparer_ItemPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. Unexpected "APPLE"
            Expected collection to not contain the specified item.
              notExpected: "APPLE"
              collection*
            """);
    ...
    public void DoesNotContain_InNonGenericCollection_WithComparer_ItemPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. APPLE
            Expected collection to not contain the specified item.
              notExpected: "APPLE"
              collection*
            """);
    ...
    public void DoesNotContain_Predicate_AtLeastOneItemMatches_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. An even number exists
    ...
    public void DoesNotContain_StringVersion_SubstringPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. Unexpected substring
    ...
    public void DoesNotContain_StringWithComparisonAndMessage_SubstringPresent_ThrowsException()
    {
        ...
        // Assert
        action.Should().Throw<AssertFailedException>().WithMessage("""
            Assert.DoesNotContain failed. Found unexpected substring
            String contains the unexpected substring.
              substring: "BROWN"
              value: "The quick brown fox"
            """);
...
#pragma warning restore CA1865 // Use char overload
    ...
    public void ContainsSinglePredicate_WithMessage_NoItemMatches_ThrowsException()
    {
        ...
        action.Should().Throw<AssertFailedException>()
            .WithMessage("""
                Assert.ContainsSingle failed. No even numbers found in collection with 3 items
                Expected exactly one item to match the predicate but found 0 item(s).
                  predicate: x => x % 2 == 0
                """);
    }
    ...
    public void ContainsSinglePredicate_InNonGenericCollection_WithMessage_MultipleItemsMatch_ThrowsException()
    {
        ...
        action.Should().Throw<AssertFailedException>()
            .WithMessage("""
                Assert.ContainsSingle failed. Too many even numbers found: 2
                Expected exactly one item to match the predicate but found 2 item(s).
                  predicate: x => x is int i && i % 2 == 0
                """);
    }
    ...
    #region Contains/DoesNotContain string truncation and newline escaping

    public void Contains_String_WithLongExpression_ShouldTruncateExpression()
    {
    ...
    public void Contains_String_WithLongValue_ShouldTruncateValue()
    {
    ...
    public void Contains_String_WithNewlineInValue_ShouldEscapeNewlines()
    {
    ...
    public void DoesNotContain_String_WithLongExpression_ShouldTruncateExpression()
    {
    ...
    public void DoesNotContain_String_WithLongValue_ShouldTruncateValue()
    {
    ...
    public void DoesNotContain_String_WithNewlineInValue_ShouldEscapeNewlines()
    {
