...
namespace Microsoft.VisualStudio.TestPlatform.MSTestAdapter.UnitTests.Discovery
{
    ...
    public class TypeEnumeratorTests
    {
        ...
        public void GetTestFromMethodShouldSetDeploymentItemsToNullIfNotPresent()
        {
            ...
            // Setup mocks
            this.mockReflectHelper.Setup(rh => rh.GetCustomAttributes(It.IsAny<MemberInfo>(), typeof(UTF.DeploymentItemAttribute))).Returns(new object[] { });
        ...
        public void GetTestFromMethodShouldSetDeploymentItems()
        {
            ...
            // Setup mocks
            this.mockReflectHelper.Setup(rh => rh.GetCustomAttributes(typeof(DummyTestClass).GetTypeInfo(), typeof(UTF.DeploymentItemAttribute))).Returns(new object[] { new UTF.DeploymentItemAttribute("C:\\temp") });
            this.mockReflectHelper.Setup(rh => rh.GetCustomAttributes(methodInfo, typeof(UTF.DeploymentItemAttribute))).Returns(new object[] { });
            this.testablePlatformServiceProvider.MockTestDeployment.Setup(
