...
#pragma warning restore SA1009 // Closing parenthesis should be spaced correctly
    ...
    private static void AssertSerialize(Type type, string instanceSerialized)
    {
        ...
        {
            Assert.AreEqual("""{"node":{"uid":"uid","display-name":"DisplayName","traits":[{"testmetadata-key":"testmetadata-value"}],"key":"value","location.file":"filePath","location.line-start":1,"location.line-end":2,"location.type":"namespace.typeName","location.method":"methodName(param1,param2)","location.method-arity":0,"time.start-utc":"2023-01-01T01:01:01.0000000+00:00","time.stop-utc":"2023-01-01T01:01:01.0000000+00:00","time.duration-ms":0,"standardOutput":"textProperty","standardError":"textProperty2","node-type":"action","execution-state":"failed","error.message":"sample","error.stacktrace":"","assert.actual":"","assert.expected":""},"parent":"parent-uid"}""".Replace(" ", string.Empty), instanceSerialized, because);
            return;
        }
