...
public class TestResultExtensionsTests : TestContainer
{
    ...
    {
        UTF.TestResult[] results = new[] { new UTF.TestResult() { TestFailureException = new Exception() } };
    ...
    {
        UTF.TestResult[] results = new[] { new UTF.TestResult() { TestFailureException = new Exception(), Outcome = UTF.UnitTestOutcome.Inconclusive } };
        MSTest.TestAdapter.ObjectModel.UnitTestResult[] convertedResults = results.ToUnitTestResults();
    ...
    {
        UTF.TestResult[] results = new[] { new UTF.TestResult() { ResultFiles = new List<string>() { "DummyFile.txt" } } };
        MSTest.TestAdapter.ObjectModel.UnitTestResult[] convertedResults = results.ToUnitTestResults();
