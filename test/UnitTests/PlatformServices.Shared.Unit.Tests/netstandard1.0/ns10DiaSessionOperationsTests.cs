...
public class DiaSessionOperationsTests
{
    ...
    public void CreateNavigationSessionShouldReturnDiaSession()
    {
        try
        {
            ...
            var diaSession = fileOperations.CreateNavigationSession(typeof(DiaSessionOperationsTests).GetTypeInfo().Assembly.Location);
...
out string fileName);
    ...
    public void DisposeNavigationSessionShouldDisposeDiaSession()
    {
        try
        {
            ...
            var diaSession = fileOperations.CreateNavigationSession(typeof(DiaSessionOperationsTests).GetTypeInfo().Assembly.Location);
            fileOperations.DisposeNavigationSession(diaSession);
