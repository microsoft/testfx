...
#pragma warning restore SA1649 // File name must match first type name
{
    ...
    {
        settingsProvider = new MSTestSettingsProvider();
    ...
    public void GetPropertiesShouldReturnDeploymentInformation()
    {
        ...
        var properties = settingsProvider.GetProperties(null);
    ...
    {
        ActionUtility.ActionShouldThrowExceptionOfType(() => settingsProvider.Load(null), typeof(ArgumentNullException));
    }
