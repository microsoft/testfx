...
/// executed <see cref="TestCase"/> to replace the framework's executor URI with the platform's own. Because
/// the method mutates the <see cref="TestCase"/>, each iteration operates on a freshly constructed instance.
/// </summary>
[MemoryDiagnoser]
