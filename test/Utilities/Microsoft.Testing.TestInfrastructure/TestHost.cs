        ...
        try
        {
            ...
            return await Policy
                ...
                .ExecuteAsync(async () =>
                {
                    ...
                    // Disable ANSI rendering by default so tests have easier time parsing the output.
                    // Disable progress by default so tests don't mix progress with overall progress.
