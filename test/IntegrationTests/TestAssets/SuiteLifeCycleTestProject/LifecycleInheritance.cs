...
public class TestClassBaseEndOfAssembly
{
    ...
    public static void BaseClassInit(TestContext testContext)
    {
        Console.WriteLine("TestClassBaseEndOfAssembly: ClassInitialize");
    }

    [ClassCleanup(InheritanceBehavior.BeforeEachDerivedClass, ClassCleanupBehavior.EndOfAssembly)]
    public static void BaseClassCleanup()
    {
        Console.WriteLine("TestClassBaseEndOfAssembly: ClassCleanup");
    }
}
...
{
    [ClassInitialize(InheritanceBehavior.BeforeEachDerivedClass)]
    public static void IntermediateClassInit(TestContext testContext)
    {
...
public class TestClassIntermediateEndOfClassBaseEndOfAssembly : TestClassBaseEndOfAssembly
{
    ...
    public static void IntermediateClassInit(TestContext testContext)
    {
        Console.WriteLine("TestClassIntermediateEndOfClassBaseEndOfAssembly: ClassInitialize");
    }

    [ClassCleanup(InheritanceBehavior.BeforeEachDerivedClass, ClassCleanupBehavior.EndOfClass)]
    public static void IntermediateClassCleanup()
    {
        Console.WriteLine("TestClassIntermediateEndOfClassBaseEndOfAssembly: ClassCleanup");
    }
}
...
public class TestClassIntermediateEndOfAssemblyBaseEndOfAssembly : TestClassBaseEndOfAssembly
{
    ...
    public static void IntermediateClassInit(TestContext testContext)
    {
        Console.WriteLine("TestClassIntermediateEndOfAssemblyBaseEndOfAssembly: ClassInitialize");
    }

    [ClassCleanup(InheritanceBehavior.BeforeEachDerivedClass, ClassCleanupBehavior.EndOfClass)]
    public static void IntermediateClassCleanup()
    {
        Console.WriteLine("TestClassIntermediateEndOfAssemblyBaseEndOfAssembly: ClassCleanup");
    }
}
...
public class TestClassIntermediateEndOfAssemblyBaseEndOfClass : TestClassBaseEndOfClass
{
    ...
    public static void IntermediateClassInit(TestContext testContext)
    {
        Console.WriteLine("TestClassIntermediateEndOfAssemblyBaseEndOfClass: ClassInitialize");
    }

    [ClassCleanup(InheritanceBehavior.BeforeEachDerivedClass, ClassCleanupBehavior.EndOfClass)]
    public static void IntermediateClassCleanup()
    {
        Console.WriteLine("TestClassIntermediateEndOfAssemblyBaseEndOfClass: ClassCleanup");
    }
}
...
public class TestClassDerived_EndOfClass : TestClassBaseEndOfClass
{
    ...
    {
        Console.WriteLine("TestClassDerived_EndOfClass: TestMethod");
    }
}
...
public class TestClassDerived_EndOfAssembly : TestClassBaseEndOfAssembly
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerived_EndOfAssembly: TestMethod");
    }
}
...
public class TestClassDerivedEndOfClass_EndOfClassEndOfAssembly : TestClassIntermediateEndOfClassBaseEndOfAssembly
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerivedEndOfClass_EndOfClassEndOfAssembly: TestMethod");
    }

    [ClassCleanup(ClassCleanupBehavior.EndOfClass)]
    public static void ClassCleanup()
    {
        Console.WriteLine("TestClassDerivedEndOfClass_EndOfClassEndOfAssembly: ClassCleanup");
    }
}
...
public class TestClassDerived_EndOfClassEndOfAssembly : TestClassIntermediateEndOfClassBaseEndOfAssembly
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerived_EndOfClassEndOfAssembly: TestMethod");
    }
}
...
public class TestClassDerivedEndOfClass_EndOfAssemblyEndOfClass : TestClassIntermediateEndOfAssemblyBaseEndOfClass
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerivedEndOfClass_EndOfAssemblyEndOfClass: TestMethod");
    }

    [ClassCleanup(ClassCleanupBehavior.EndOfClass)]
    public static void ClassCleanup()
    {
        Console.WriteLine("TestClassDerivedEndOfClass_EndOfAssemblyEndOfClass: ClassCleanup");
    }
}
...
public class TestClassDerived_EndOfAssemblyEndOfClass : TestClassIntermediateEndOfAssemblyBaseEndOfClass
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerived_EndOfAssemblyEndOfClass: TestMethod");
    }
}
...
public class TestClassDerivedEndOfClass_EndOfAssemblyEndOfAssembly : TestClassIntermediateEndOfAssemblyBaseEndOfAssembly
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerivedEndOfClass_EndOfAssemblyEndOfAssembly: TestMethod");
    }

    [ClassCleanup(ClassCleanupBehavior.EndOfClass)]
    public static void ClassCleanup()
    {
        Console.WriteLine("TestClassDerivedEndOfClass_EndOfAssemblyEndOfAssembly: ClassCleanup");
    }
}
...
public class TestClassDerived_EndOfAssemblyEndOfAssembly : TestClassIntermediateEndOfAssemblyBaseEndOfAssembly
{
    ...
    public void TestMethod()
    {
        Console.WriteLine("TestClassDerived_EndOfAssemblyEndOfAssembly: TestMethod");
    }
}
