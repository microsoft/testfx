...
public class SuiteLifeCycleTests : CLITestBase
{
    ...
    public void ValidateInheritanceBehavior()
    {
        ...
        var testMethod2 = RunEventsHandler.PassedTests.Single(x => x.TestCase.FullyQualifiedName.EndsWith("TestClassDerivedEndOfClass_EndOfClassEndOfClass.TestMethod"));
        ...
        var testMethod3 = RunEventsHandler.PassedTests.Single(x => x.TestCase.FullyQualifiedName.EndsWith("TestClassDerived_EndOfClassEndOfClass.TestMethod"));
    ...
    private void ValidateTestRunLifecycle(string targetFramework)
    {
        ...
        RunEventsHandler.PassedTests.Should().HaveCount(20);  // The inherit class tests are called twice.
        ...
        caseDerivedClassInitializeNoneAndClassCleanupBeforeEachDerivedClassParentTestMethod.Messages[2].Text.Should().Be(
            $"""
