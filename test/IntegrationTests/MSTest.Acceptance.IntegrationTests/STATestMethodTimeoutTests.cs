...
[TestClass]
public sealed class STATestMethodTimeoutTests : AcceptanceTestBase<STATestMethodTimeoutTests.TestAssetFixture>
{
    private const string AssetName = "TimeoutSTATestMethodProject";
