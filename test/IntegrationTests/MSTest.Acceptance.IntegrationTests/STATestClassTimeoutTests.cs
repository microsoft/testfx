...
[TestClass]
public sealed class STATestClassTimeoutTests : AcceptanceTestBase<STATestClassTimeoutTests.TestAssetFixture>
{
    private const string AssetName = "TimeoutSTATestClass";
