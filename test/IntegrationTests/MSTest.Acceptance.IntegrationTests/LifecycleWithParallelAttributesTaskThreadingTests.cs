...
[TestClass]
public sealed class LifecycleWithParallelAttributesTaskThreadingTests : AcceptanceTestBase<LifecycleWithParallelAttributesTaskThreadingTests.TestAssetFixture>
{
    [TestMethod]
    ...
    {
        var testHost = TestHost.LocateFrom(AssetFixture.TargetAssetPath, TestAssetFixture.AssemblyName, tfm);
