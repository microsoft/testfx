...
public sealed class HangDumpTests : BaseAcceptanceTests
{
    ...
    public sealed class HangDumpFixture : IAsyncInitializable, IDisposable
    {
        ...
        {
            _testAsset = await TestAsset.GenerateAssetAsync("HangDumpFixture", Sources.PatchCodeWithRegularExpression("tfms", TargetFrameworks.All.ToMSBuildTargetFrameworks()));
