...
public sealed class CrashDumpTests : BaseAcceptanceTests
{
    ...
    public sealed class HangDumpFixture : IAsyncInitializable, IDisposable
    {
        ...
        {
            _testAsset = await TestAsset.GenerateAssetAsync("CrashDumpFixture", Sources.PatchCodeWithRegularExpression("tfms", TargetFrameworks.All.ToMSBuildTargetFrameworks()));
