...
[TestClass]
public sealed class SuiteLifeCycleTestClass_ClassCleanupWithInheritanceBehaviorBeforeEachDerivedClass : IDisposable
#if NET6_0_OR_GREATER
        , IAsyncDisposable 
#endif
{
    ...
    public SuiteLifeCycleTestClass_ClassCleanupWithInheritanceBehaviorBeforeEachDerivedClass()
    {
