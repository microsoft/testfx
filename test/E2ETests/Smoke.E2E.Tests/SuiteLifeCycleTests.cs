...
public class SuiteLifeCycleTests : CLITestBase
{
    ...
    private void ValidateTestRunLifecycle(string targetFramework)
    {
        ...
        {
            expectedMessages.Add("Console: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.DisposeAsync was called");
        }

        caseDerivedClassInitializeNoneAndClassCleanupBeforeEachDerivedClassParentTestMethod.Messages[0].Text.Split(new[] { "\r\n" }, StringSplitOptions.None).Should().BeEquivalentTo(expectedMessages);
        ...
        expectedMessages = new List<string>
        {
            ...
            "Trace: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.Dispose was called",
            "Debug: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.Dispose was called",
            "Trace: LifeCycleDerivedClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleClassCleanupEndOfAssemblyAndBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleClassCleanupEndOfAssemblyAndBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassCleanupEndOfAssemblyAndNone.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassCleanupEndOfAssemblyAndNone.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassCleanupEndOfClassAndBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassCleanupEndOfClassAndBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassCleanupEndOfAssemblyAndBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassCleanupEndOfAssemblyAndBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassCleanupEndOfClassAndNone.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassCleanupEndOfClassAndNone.ClassCleanup was called",
            "Trace: LifeCycleClassCleanupEndOfAssemblyAndNone.ClassCleanup was called",
            "Debug: LifeCycleClassCleanupEndOfAssemblyAndNone.ClassCleanup was called",
            "Trace: LifeCycleClassCleanup.ClassCleanup was called",
            "Debug: LifeCycleClassCleanup.ClassCleanup was called",
            "Trace: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassInitializeAndCleanupNone.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassInitializeAndCleanupNone.ClassCleanup was called",
            "Trace: LifeCycleClassInitializeAndCleanupNone.ClassCleanup was called",
            "Debug: LifeCycleClassInitializeAndCleanupNone.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassInitializeAndCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassInitializeAndCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleClassInitializeAndCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleClassInitializeAndCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleClassInitializeAndCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Debug: LifeCycleClassInitializeAndCleanupBeforeEachDerivedClass.ClassCleanup was called",
            "Trace: LifeCycleDerivedClassInitializeBeforeEachDerivedClassAndClassCleanupNone.ClassCleanup was called",
            "Debug: LifeCycleDerivedClassInitializeBeforeEachDerivedClassAndClassCleanupNone.ClassCleanup was called",
            "Trace: LifeCycleClassInitializeBeforeEachDerivedClassAndClassCleanupNone.ClassCleanup was called",
            "Debug: LifeCycleClassInitializeBeforeEachDerivedClassAndClassCleanupNone.ClassCleanup was called",
            "Trace: LifeCycleClassCleanupEndOfAssembly.ClassCleanup was called",
            "Debug: LifeCycleClassCleanupEndOfAssembly.ClassCleanup was called",
            "AssemblyCleanup was called",
            string.Empty,
        };
        if (targetFramework == "net6.0")
        {
            expectedMessages.Add("Trace: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.DisposeAsync was called");
            expectedMessages.Add("Debug: LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.DisposeAsync was called");
        }

        caseDerivedClassInitializeNoneAndClassCleanupBeforeEachDerivedClassParentTestMethod.Messages[1].Text.Split(new[] { "\r\n" }, StringSplitOptions.None).Should().BeEquivalentTo(expectedMessages);
        ...
        if (targetFramework == "net6.0")
        {
            expectedMessages.Add("LifeCycleClassInitializeNoneAndClassCleanupBeforeEachDerivedClass.DisposeAsync was called");
        }

        caseDerivedClassInitializeNoneAndClassCleanupBeforeEachDerivedClassParentTestMethod.Messages[2].Text.Split(new[] { "\r\n" }, StringSplitOptions.None).Should().BeEquivalentTo(expectedMessages);
    }
}
