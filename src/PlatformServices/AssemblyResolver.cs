...
namespace Microsoft.VisualStudio.TestPlatform.MSTestAdapter.PlatformServices
{
    ...
    public class AssemblyResolver : MarshalByRefObject, IDisposable
    {
        ...
        {
            return this.OnResolveInternal(args, true);
        }
        ...
        {
            return this.OnResolveInternal(args, false);
        }
        ...
        /// 
        /// <returns> The <see cref="Assembly"/>.  </returns>
        private Assembly OnResolveInternal(ResolveEventArgs args, bool isReflectionOnly)
        {
