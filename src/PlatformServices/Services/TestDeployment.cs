...
namespace Microsoft.VisualStudio.TestPlatform.MSTestAdapter.PlatformServices
{
    ...
    public class TestDeployment : ITestDeployment
    {
        ...
        public bool Deploy(IEnumerable<TestCase> tests, IRunContext runContext, IFrameworkHandle frameworkHandle)
        {
            ...
            // TODO: @haplois, add this support back
            // File: https://github.com/microsoft/vstest/blob/1539d8b6c2a6635d9fae371c707b8fcbac7c1be8/src/Microsoft.TestPlatform.ObjectModel/Utilities/SuspendCodeCoverage.cs
#if NETFRAMEWORK
