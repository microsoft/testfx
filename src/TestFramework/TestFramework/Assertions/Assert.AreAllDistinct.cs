...
#pragma warning restore CS8714
    ...
    /// <summary>
    /// Tests whether all elements in the specified array are distinct and throws an exception if any two elements are equal.
    /// </summary>
    ...
    public static void AreAllDistinct<T>([NotNull] T[]? collection, string? message = "", [CallerArgumentExpression(nameof(collection))] string collectionExpression = "")
        => AreAllDistinct((IEnumerable<T>?)collection, message, collectionExpression);
