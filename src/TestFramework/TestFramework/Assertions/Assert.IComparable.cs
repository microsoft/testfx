...
public sealed partial class Assert
{
    ...
    /// </exception>
    public static void IsGreaterThan<T>(T lowerBound, T value, string? message = null, [CallerArgumentExpression(nameof(lowerBound))] string lowerBoundExpression = "", [CallerArgumentExpression(nameof(value))] string valueExpression = "")
    ...
    /// </exception>
    public static void IsGreaterThanOrEqualTo<T>(T lowerBound, T value, string? message = null, [CallerArgumentExpression(nameof(lowerBound))] string lowerBoundExpression = "", [CallerArgumentExpression(nameof(value))] string valueExpression = "")
        where T : IComparable<T>
    {
        if (value.CompareTo(lowerBound) >= 0)
        {
    ...
    /// </exception>
    public static void IsLessThan<T>(T upperBound, T value, string? message = null, [CallerArgumentExpression(nameof(upperBound))] string upperBoundExpression = "", [CallerArgumentExpression(nameof(value))] string valueExpression = "")
        where T : IComparable<T>
    {
    ...
    /// </exception>
    public static void IsLessThanOrEqualTo<T>(T upperBound, T value, string? message = null, [CallerArgumentExpression(nameof(upperBound))] string upperBoundExpression = "", [CallerArgumentExpression(nameof(value))] string valueExpression = "")
        where T : IComparable<T>
    {
        if (value.CompareTo(upperBound) <= 0)
        {
    ...
    /// </exception>
    public static void IsPositive<T>(T value, string? message = null, [CallerArgumentExpression(nameof(value))] string valueExpression = "")
    ...
    /// </exception>
    public static void IsNegative<T>(T value, string? message = null, [CallerArgumentExpression(nameof(value))] string valueExpression = "")
        where T : struct, IComparable<T>
    {
        var zero = default(T);
