...
#pragma warning restore IDE0004 // Casts are required to forward to the legacy IEnumerable overload.
    ...
    /// <summary>
    /// Tests whether the specified collection does not contain every element of <paramref name="notExpected"/> using the specified equality comparer.
    /// </summary>
    /// <remarks>
    ...
    /// <param name="notExpected">The collection of items that must not all be present in <paramref name="collection"/>.</param>
    ...
    /// </exception>
#pragma warning disable IDE0004 // Casts are required to forward to the legacy IEnumerable overload.
    public static void DoesNotContainAll<T, TNotExpectedCollection, TCollection>([NotNull] TNotExpectedCollection? notExpected, [NotNull] TCollection? collection, [NotNull] IEqualityComparer<T>? comparer, string? message = "", [CallerArgumentExpression(nameof(notExpected))] string notExpectedExpression = "", [CallerArgumentExpression(nameof(collection))] string collectionExpression = "")
