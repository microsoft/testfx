...
namespace Microsoft.VisualStudio.TestTools.UnitTesting
{
    ...
    public class PrivateObject
    {
        ...
        public PrivateObject(string assemblyName, string typeName, params object[] args) : this(assemblyName, typeName, null, args)
        {
        }
        ...
        /// <param name="args">Argmenets to pass to the constructor</param>
        public PrivateObject(Type type, params object[] args) : this(type, null, args)
        {
        ...
        // bind everything
        const BindingFlags BindToEveryThing = BindingFlags.Default | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public;
        ...
        static void ValidateAccessString(string access)
        {
            ...
            {
                if ((str.Length == 0) || (-1 != str.IndexOfAny(new char[] { ' ', '\t', '\n' })))
                {
                    throw new ArgumentException(FrameworkMessages.AccessStringInvalidSyntax);
                }
            }
        ...
        {
            Helper.CheckParameterNotNull(name, "name", string.Empty);
            Debug.Assert((null != this.target), "Internal Error: Null reference is returned for internal object");
