...
internal static class MSTestTestNodeConverter
{
    ...
    private static TestNode CreateBaseTestNode(UnitTestElement element, bool isTrxEnabled, string? displayNameOverride, out TestMethodIdentifierProperty? testMethodIdentifier)
    {
        ...
        testMethodIdentifier = AddTestMethodIdentifier(testNode, element);
    ...
    private static TestMethodIdentifierProperty? AddTestMethodIdentifier(TestNode testNode, UnitTestElement element)
    {
        TestMethod testMethod = element.TestMethod;
    ...
    private static void AddTrxResultProperties(TestNode testNode, UnitTestElement element, string? errorMessage, string? errorStackTrace, TestMethodIdentifierProperty? testMethodIdentifier)
    {
        ...
        if (testMethodIdentifier is not null)
        {
            testNode.Properties.Add(new TrxFullyQualifiedTypeNameProperty(
                StringEx.IsNullOrEmpty(testMethodIdentifier.Namespace)
                    ? testMethodIdentifier.TypeName
                    : $"{testMethodIdentifier.Namespace}.{testMethodIdentifier.TypeName}"));
        }
