...
namespace Microsoft.VisualStudio.TestPlatform.MSTest.TestAdapter.ObjectModel
{
    ...
    public class UnitTestResult
    {
        ...
        internal TestResult ToTestResult(TestCase testCase, DateTimeOffset startTime, DateTimeOffset endTime, MSTestSettings currentSettings)
        {
            ...
            {
                TestResultMessage message = new TestResultMessage(TestResultMessage.StandardOutCategory, StandardOut);
                testResult.Messages.Add(message);
            }

            if (!string.IsNullOrEmpty(StandardError))
            {
                TestResultMessage message = new TestResultMessage(TestResultMessage.StandardErrorCategory, StandardError);
                testResult.Messages.Add(message);
            }
