...
#pragma warning restore VSTHRD101 // Avoid unsupported async delegates
                        ...
                        result.Outcome = UTFUnitTestOutcome.Passed;
                    }
                }
            }
            catch (Exception ex)
            {
                ...
                {
                    result.Outcome = UTFUnitTestOutcome.Timeout;
                ...
                if (result.Outcome != UTFUnitTestOutcome.Passed)
                {
...
#pragma warning restore IDE0057 // Use range operator
        ...
        RunTestCleanupMethodAsync(TestResult result, ExecutionContext? executionContext, CancellationTokenSource? timeoutTokenSource)
    {
        ...
        UTFUnitTestOutcome outcomeFromRealException = realException is AssertInconclusiveException ? UTFUnitTestOutcome.Inconclusive : UTFUnitTestOutcome.Failed;
    ...
    private bool SetTestContext(object classInstance, TestResult result)
    {
        ...
        catch (Exception ex)
        {
            ...
            result.Outcome = UTFUnitTestOutcome.Failed;
    ...
    private async Task<TestResult> ExecuteInternalWithTimeoutAsync(object?[]? arguments)
    {
        ...
        if (TimeoutInfo.CooperativeCancellation)
        {
            ...
            try
            {
                ...
                if (timeoutTokenSource.Token.IsCancellationRequested)
                {
                    return new()
                    {
                        Outcome = UTFUnitTestOutcome.Timeout,
        ...
        TestResult timeoutResult = new() { Outcome = UTFUnitTestOutcome.Timeout, TestFailureException = new TestFailedException(UTFUnitTestOutcome.Timeout, errorMessage) };
