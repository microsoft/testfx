...
namespace MSTest.PlatformServices.Extensions;
...
internal static class MethodInfoExtensions
{
    ...
    internal static Task? GetInvokeResultAsync(this MethodInfo methodInfo, object? classInstance, params object?[]? arguments)
    {
        ...
        if (methodParameters is { Length: > 0 } && arguments == null)
        {
            throw new TestFailedException(
                Microsoft.VisualStudio.TestTools.UnitTesting.UnitTestOutcome.Error,
                string.Format(
    ...
    private static MethodInfo ConstructGenericMethod(MethodInfo methodInfo, object?[]? arguments)
    {
        ...
        if (arguments is null)
        {
            ...
            throw new TestFailedException(Microsoft.VisualStudio.TestTools.UnitTesting.UnitTestOutcome.Error, string.Format(CultureInfo.InvariantCulture, Resource.GenericParameterCantBeInferredBecauseNoArguments, methodInfo.Name));
        }
        ...
        catch (Exception e)
        {
            ...
            throw new TestFailedException(Microsoft.VisualStudio.TestTools.UnitTesting.UnitTestOutcome.Error, e.TryGetMessage(), e.TryGetStackTraceInformation(), e);
        }
    }
