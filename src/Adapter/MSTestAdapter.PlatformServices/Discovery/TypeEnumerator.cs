...
internal class TypeEnumerator
{
    ...
    internal UnitTestElement GetTestFromMethod(MethodInfo method, ICollection<string> warnings)
    {
        ...
        PlatformServiceProvider.Instance.ManagedNameUtilityService.GetManagedName(method, out string managedType, out string managedMethod, out string?[]? hierarchyValues);
