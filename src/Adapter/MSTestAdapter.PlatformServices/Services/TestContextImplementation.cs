...
#pragma warning restore IDE0022 // Use expression body for method
    ...
    // Folded data-driven iterations share a single TestMethodRunner; each iteration must use a fresh context
    // so accumulated state (output, errors, trace, properties, result files) does not leak across rows.
    internal TestContextImplementation CreateForDataDrivenIteration()
