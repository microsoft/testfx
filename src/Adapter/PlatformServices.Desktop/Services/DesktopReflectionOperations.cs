...
public class ReflectionOperations : IReflectionOperations
{
    ...
    /// </summary>
    public ReflectionOperations() => _reflectionUtility = new ReflectionUtility();
    ...
    public object[] GetCustomAttributes(MemberInfo memberInfo, bool inherit) => _reflectionUtility.GetCustomAttributes(memberInfo, inherit);
    ...
    /// <param name="inherit"> True to inspect the ancestors of element; otherwise, false. </param>
    /// <returns> The list of attributes on the member. Empty list if none found. </returns>
    public object[] GetCustomAttributes(MemberInfo memberInfo, Type type, bool inherit) => _reflectionUtility.GetCustomAttributes(memberInfo, type, inherit);
    ...
    public object[] GetCustomAttributes(Assembly assembly, Type type) => _reflectionUtility.GetCustomAttributes(assembly, type);
}
