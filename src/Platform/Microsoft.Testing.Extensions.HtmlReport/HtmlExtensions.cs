...
public static class HtmlExtensions
{
    ...
    public static void AddHtmlProvider(this ITestApplicationBuilder builder)
    {
        var compositeTestSessionAzDoService =
           new CompositeExtensionFactory<HtmlReporter>(serviceProvider =>
               new HtmlReporter(
        ...
        builder.CommandLine.AddProvider(() => new HtmlCommandLineProvider());
    }
}
