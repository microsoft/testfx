...
public static class TestApplicationBuilderExtensions
{
    ...
    public static void AddRunSettingsService(this ITestApplicationBuilder builder, IExtension extension)
    {
        ...
        {
            testApplicationBuilder.Configuration.AddConfigurationSource(() => new RunSettingsConfigurationProvider(extension));
        }
        ...
        builder.TestHostControllers.AddEnvironmentVariableProvider(serviceProvider =>
            new RunSettingsEnvironmentVariableProvider(extension, serviceProvider.GetConfiguration()));
    }
