...
""";
    ...
    public override bool Execute()
    {
        ...
        if (!Log.HasLoggedErrors)
        {
            ...
            {
                GenerateCode(Language.ItemSpec, taskItems, SelfRegisteredExtensionsSourcePath, _fileSystem, Log);
    ...
    private static string GetSourceCode(string language, string extensionsFragments)
    {
        ...
        if (language == FSharpLanguageSymbol)
        {
            return $"""
                     //------------------------------------------------------------------------------
                     // <auto-generated>
