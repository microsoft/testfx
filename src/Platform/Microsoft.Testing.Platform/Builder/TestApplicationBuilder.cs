...
internal sealed class TestApplicationBuilder : ITestApplicationBuilder
{
    ...
    internal static Func<ITestHostBuilder> TestHostBuilderFactory { get; set; }
        = () => new TestHostBuilder(new SystemFileSystem(), new SystemRuntimeFeature(), new SystemEnvironment(), new SystemProcessHandler(), new CurrentTestApplicationModuleInfo(new SystemEnvironment(), new SystemProcessHandler()));
