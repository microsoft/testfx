...
internal sealed record FailedTestResultMessage(string? Uid, string? DisplayName, byte? State, long? Duration, string? Reason, ErrorMessage[]? ErrorMessage, string? StandardOutput, string? ErrorOutput, string? SessionUid);
