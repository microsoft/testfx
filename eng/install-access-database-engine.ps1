...
$installerPath = Join-Path ([System.IO.Path]::GetTempPath()) "accessdatabaseengine_X64_$PID.exe"
try {
    Invoke-RestMethod https://download.microsoft.com/download/3/5/C/35C84C36-661A-44E6-9324-8786B8DBE231/accessdatabaseengine_X64.exe -OutFile $installerPath
    Start-Process $installerPath -Wait -ArgumentList "/quiet /passive /norestart"
}
finally {
