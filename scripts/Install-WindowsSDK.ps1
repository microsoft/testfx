...
Write-Host "Downloading Windows SDK 10.0.26624..." -ForegroundColor Green
Invoke-WebRequest -Method Get -Uri https://go.microsoft.com/fwlink/p/?LinkId=619296 -OutFile sdksetup.exe -UseBasicParsing
