...
function Create-NugetPackages
{
    ...
    if($TFB_Official)
    {
        $nuspecFiles = @("MSTest.TestAdapter.Dotnet.nuspec", "MSTest.TestAdapter.nuspec", "MSTest.TestAdapter.symbols.nuspec", "MSTest.TestFramework.nuspec", "MSTest.TestFramework.symbols.nuspec", "MSTest.Internal.TestFramework.Documentation.nuspec")
    }
    else
    {
