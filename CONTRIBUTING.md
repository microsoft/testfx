...
- **DO NOT** hand-edit `*.lock.yml`, `.github/workflows/package.json`, `.github/workflows/requirements.txt`, or `.github/workflows/go.mod`. They are all regenerated by `gh aw compile`.
